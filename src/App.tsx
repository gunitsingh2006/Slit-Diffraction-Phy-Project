...
import { Ruler, Lightbulb, Maximize2, ArrowRight, Move3D, Moon, Sun, Calculator } from 'lucide-react';
...
function App() {
  ...
  useEffect(() => {
    const calculateIntensity = () => {
      ...
      for (let i = 0; i < points; i++) {
        ...
        const alpha = (Math.PI * slitWidth * Math.sin(theta)) / (wavelength * 1e-6);
  ...
  return (
    <div className={`min-h-screen ${darkMode ? 'bg-gray-900 text-white' : 'bg-gray-50 text-gray-900'}`}>
      <header className={`${darkMode ? 'bg-blue-900' : 'bg-blue-600'} text-white p-6`}>
        <div className="container mx-auto flex justify-between items-center">
          ...
          <button
            ...
            className={`p-2 rounded-lg ${darkMode ? 'bg-blue-800 hover:bg-blue-700' : 'bg-blue-500 hover:bg-blue-400'} transition-colors`}
      ...
      <main className="container mx-auto p-6">
        {/* Formula Box */}
        <div className={`mb-8 ${darkMode ? 'bg-blue-900' : 'bg-blue-100'} p-6 rounded-lg shadow-lg`}>
          <h2 className="text-xl font-semibold mb-4 flex items-center gap-2">
            <Calculator className="w-6 h-6" />
            Single-Slit Diffraction Formula
          </h2>
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            <div className={`p-4 ${darkMode ? 'bg-blue-800' : 'bg-white'} rounded-lg shadow flex items-center justify-center w-full md:w-1/2`}>
              <div className="text-center">
                <p className="text-2xl mb-2">y = λL/a</p>
            ...
            <div className={`p-4 ${darkMode ? 'bg-blue-800' : 'bg-white'} rounded-lg shadow w-full md:w-1/2`}>
              <h3 className="text-lg font-semibold mb-2 text-center">Calculated Result</h3>
              <div className="text-center">
                <p className="text-3xl font-bold mb-2">±{firstMinimum.toFixed(2)} mm</p>
                <p className="text-sm opacity-80">Distance from center to first minimum</p>
                <div className="mt-4 text-sm grid grid-cols-2 gap-2">
                  <div className={`p-2 ${darkMode ? 'bg-blue-900' : 'bg-blue-50'} rounded`}>
                    <p>λ = {wavelength} nm</p>
                  </div>
                  <div className={`p-2 ${darkMode ? 'bg-blue-900' : 'bg-blue-50'} rounded`}>
                    <p>a = {slitWidth} mm</p>
                  </div>
                  <div className={`p-2 ${darkMode ? 'bg-blue-900' : 'bg-blue-50'} rounded col-span-2`}>
                    <p>L = {distance} mm</p>
                  </div>
                </div>
              </div>
          ...
          <div className="relative h-48 bg-black rounded-lg overflow-hidden">
            ...
            <div className="absolute left-4 top-1/2 -translate-y-1/2">
              ...
              <div 
                ...
                style={{
                  background: `linear-gradient(90deg, ${wavelengthToColor(wavelength)}, transparent)`,
                }}
              ></div>
            </div>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <div className={`${darkMode ? 'bg-gray-800' : 'bg-white'} p-6 rounded-lg shadow-lg`}>
            <h2 className="text-xl font-semibold mb-4">Experiment Parameters</h2>
            ...
            <div className="space-y-4">
              <div>
                ...
                <span className={`text-sm ${darkMode ? 'text-gray-300' : 'text-gray-600'}`}>{wavelength} nm</span>
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full"
                />
                <span className={`text-sm ${darkMode ? 'text-gray-300' : 'text-gray-600'}`}>{slitWidth} mm</span>
              </div>
          ...
          {/* Results */}
          <div className={`${darkMode ? 'bg-gray-800' : 'bg-white'} p-6 rounded-lg shadow-lg`}>
            <h2 className="text-xl font-semibold mb-4">Diffraction Pattern</h2>
        ...
        <div className={`mt-8 ${darkMode ? 'bg-gray-800' : 'bg-white'} p-6 rounded-lg shadow-lg`}>
          ...
          <div className="prose max-w-none">
            <p>
              Single-slit diffraction occurs when light waves pass through a narrow aperture. 
              The width of the slit affects how the light waves interact and create an 
            ...
            <div className="mt-4 grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className={`${darkMode ? 'bg-gray-700' : 'bg-gray-50'} p-4 rounded-lg`}>
                ...
                <ul className="list-disc list-inside space-y-2">
                  ...
                  <li>The central maximum is twice as wide as the secondary maxima</li>
                </ul>
              </div>
              <div className={`${darkMode ? 'bg-gray-700' : 'bg-gray-50'} p-4 rounded-lg`}>
                <h3 className="font-semibold text-lg mb-2">Mathematical Description</h3>
